...
def detalhes(id):
    ...
    lista_cardapios = Cardapio.query.filter_by(restaurante=lista_restaurantes.restaurante).all()
    ...
    return render_template('restaurante_detalhes.html', cardapio=lista_cardapios, restaurante=lista_restaurantes, tipo=lista_restaurantes)
